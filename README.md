# TaxiAdmin rewritten in Angular9 and Bootstrap 4

this App built using Angular 9 and Bootstrap 4
...
`taxi-admin` provides the following features:
...
```bash
$ git clone https://gitlab.com/eliascapasso/taxiadmin.git 
$ cd taxiadmin
